export const ShowCase = (props: JSX.IntrinsicElements["svg"]) => {
  return (
    <svg
    ...
    >
      ...
      <title>notes1</title>
      <g opacity="0.5">
        <rect width="419.96" height="290.83" fill="url(#5b26331d-1310-4294-a782-4ee218ce8a93)" />
      </g>
      <rect x="4.34" y="4.34" width="412.36" height="283.23" fill="#f7f7f7" />
      <g opacity="0.5">
        <circle cx="71.35" cy="100.38" r="7.6" fill="#6c63ff" />
      ...
      <g opacity="0.5">
        <circle cx="217.85" cy="218.66" r="7.6" fill="#6c63ff" />
      ...
      <polygon
        ...
        fill="#e0e0e0"
      />
      <path d="M915.1,405.51" transform="translate(-144.63 -186.3)" fill="#6c63ff" />
      <path
